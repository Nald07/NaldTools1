...
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : Ronald Hendrawan           |" | lolcat
echo  "|              Instagram       : @naldd07                   |" | lolcat
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"RONALD ID"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Instagram :"$i"@nald"
echo $ku"Facebook :"$i" Ronald ID"
sleep 2
